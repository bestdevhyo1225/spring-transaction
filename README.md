...
<img width="588" alt="스크린샷 2022-06-13 오후 2 59 02" src="https://user-images.githubusercontent.com/23515771/173289225-596deb36-3a7f-4f78-aee4-c4833100f683.png">
...
- 실제 데이터베이스에 적용되는 트랜잭션을 뜻한다. (실제 커넥션을 통해서 트랜잭션을 시작하고(`setAutoCommit(false)`), 커밋, 롤백하는 단위를 말한다.)
